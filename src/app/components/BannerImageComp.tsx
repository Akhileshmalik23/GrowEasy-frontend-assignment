  ...
  return (
    <>
      ...
      >
        ...
        <button className="mt-40 ml-6 w-40 bg-gray-600 text-white py-2 px-4 rounded-lg shadow-lg hover:bg-slate-900 hover:border-red-400 hover:border-spacing-1 hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
          {button}
        </button>
